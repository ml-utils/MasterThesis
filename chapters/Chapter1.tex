...
Here is a sample item from the complex NP island testsuite we developed for this thesis:
...
\begin{table} \scriptsize 
	\begin{center}
		\begin{tabular}
			...
			\textit{Cosa hai smentito che l'agenzia avrebbe diffuso?} & -33.47 
			& \textit{Cosa hai smentito la voce che l'agenzia avrebbe diffuso?} & -32.17 & -1.29 \\ 
			\textit{Cosa hai intuito che l'agenzia avrebbe diffuso?} & -30.24  
			& \textit{Cosa hai avuto l'intuizione che l'agenzia avrebbe diffuso?} & -27.76 & -2.48 \\ 
			...
			\textit{Cosa hai annunciato che l'impresa avrebbe pareggiato?} & -30.53 & 
			\textit{Cosa hai fatto l’annuncio che l'impresa avrebbe pareggiato?} & -31.83 & 1.30\\ 	
			
			\textit{Cosa hai intuito che l'impresa avrebbe pareggiato?} & -28.95 & 
			\textit{Cosa hai avuto l'intuizione che l'impresa avrebbe pareggiato?} & -26.55  & -2.41 \\ 						
			
		\end{tabular}
		\caption{Comparing acceptability variations among sentences in the complex NP dataset.}
		\label{tab:compare1}
	\end{center}
\end{table}


% examples of items before and after the "avuto l'intuizione che" variation: ..
...
\subsubsection{Complex np islands: what seems to affect the models acceptability scores}

% TODO: table with example items with different constructs, and their scores
% TODO: plots of the whole testsuite for this phenomenon with the same variation for all items (using a different verb)
...
\subsubsection{Other notes on  Complex np islands}
