...
% island effects one of the most challenging.. (although high performance already achieved..)
% methdological problem in assessing linguistic knowledge (section ..), how to derive a grammaticality judgement or otherwise assess model linguistic knowledge, various approaches have been proposed, also drawing from psycholinguistic studies, ..now the field seem to have focused on ..minimal pairs
...
\begin{figure}
	...
	\caption{ Plots for average scores on humans (\ref{fig:sprouse_humans}) and GePpeTto (\ref{fig:md_gpt_penlp}) 
	}
