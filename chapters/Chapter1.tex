...
With other variations experiments, we found that replacing the main clause verb with .."sapeva che"/"conosceva che" (like those shown in ..), increases the acceptability of the long-non island sentences; on the other hand gives a lower acceptability to the short island sentence, compared to the results on human subjects, so that the non-island and island line are almost parallel and the DD score is close to zero, indicating al almost absent island effect.
