...
Back to the question on the clear correlation between the amound of model training data, and performance of these models on subject islands, we can have a look at the token surprisal plots for the same test item across the four models.\\
