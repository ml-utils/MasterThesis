...
In this section we compare our results obtained from transformer-based language models with those from human subjects collected by  \citet{sprouse2016experimental}. We complement this with an analysis of the models per-token surprisals given for some of the items in our test suites.
