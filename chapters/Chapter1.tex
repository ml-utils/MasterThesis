...
From \autoref{fig:wh_whether} for whether islands with wh-dependencies, we can see that the Gtp-2 model with the PenLP sentence acceptability approximation gives higher scores for sentences that don't have an island structure, with this difference being more pronounced in the scores on the original testsuite from \citet{sprouse2016experimental} (image in the middle).
