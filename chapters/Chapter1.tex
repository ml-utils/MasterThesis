...
\begin{figure}
	\begin{subfigure}{.33\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{images/Chapter1/Sprouse_humans_-_wh-whether.png}
		\caption{1a}
		\label{fig:sfig1}
	\end{subfigure}%
	\begin{subfigure}{.33\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{images/Chapter1/Sprouse_GePpeTto_PenLP-zscores-likert-wh_wheather.png}
		\caption{1b}
		\label{fig:sfig2}
	\end{subfigure}
	\begin{subfigure}{.33\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{images/Chapter1/Madeddu_GePpeTto_PenLP-zscores-likert-_wh-wheather.png}
	\caption{1c}
	\label{fig:sfig3}
	\end{subfigure}
	\caption{plots of....}
