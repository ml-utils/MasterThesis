...
Before the introduction of methods for extracting acceptability judgments from neural language models, the primary performance metric for their evaluation was perplexity, which is a broad-coverage metricthat  scores how well, on average, a model predicts a word in its contex, and captures how well the probability distribution learned by the model conforms to that of a particular linguistic domain \citep{marvin2018targeted, hu2020systematic}.  
