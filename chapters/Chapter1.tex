...
\begin{enumerate}
	...
	\begin{enumerate}
		\item \textsc{Short-NonIsland:} \\
				\textit{Who} \_ thinks that John bought a car?
		\item \textit{Who} \_ thinks that John bought a car?
	\end{enumerate}
\end{enumerate}

\begin{enumerate}[itemindent=4cm ] % wide, itemsep =0pt, topsep=0pt
	\item [\text{SHORT-NONISLAND:}] Foo
	\item [\text{L-N.I.:}] Foo
	\item [\text{S-I.S.:}] Foo
	\item [\text{L-I.S.:}] Foo
\end{enumerate}
