...
\subsection{The importance of island effects in linguistics}
...
In the first study on island effects in Italian, \citet{rizzi1982violations} argued that it was not possible to isolate the effect of wh-islands violations in Italian, because in this language there is a double-wh-prohibition ..

Rizzi focused only on syntactic islands under relative clause dependencies (a form less commonly studied than wh-interrogatives), arguing that it was problematic study them with wh-dependencies because they would require a double wh-word (as in \textit{*Chi ti domandi chi \_ ha incontrato \_?})(\textit{Who do you wonder who met?}), which itself renders a sentence unacceptable, resulting in a confound. 
