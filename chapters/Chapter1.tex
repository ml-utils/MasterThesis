...
In \autoref{fig:md_bert2b_adjunct_item_145_surprisals}, \ref{fig:md_bertxxl_adjunct_item_188_surprisals}, \ref{fig:md_gilberto_adjunct_item_185_surprisals} we can see token surprisals plots from BERT, BERT XXL, and GilBERTo on an adjunct island item. 
...
\begin{figure}[p]
	...
	\caption{Token surprisal an adjunct island item, as scored by the Italian BERT.} 
...
\begin{figure}[p]
	...
	\caption{Token surprisal an adjunct island item, as scored by the Italian BERT XXL.} 
...
\begin{figure}[p]
	...
	\caption{Token surprisal an adjunct island item, as scored by GilBERTo.} 
