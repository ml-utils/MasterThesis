...
\begin{figure}
	\begin{subfigure}{.33\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{images/Chapter1/Sprouse_humans_adjunct.png}
		\caption{1a}
		\label{fig:wh_adjunct1}
	\end{subfigure}%
	\begin{subfigure}{.33\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{images/Chapter1/Sprouse_GePpeTto_PenLP-zscores-likert.png}
		\caption{1b}
		\label{fig:wh_adjunct2}
	\end{subfigure}
	\begin{subfigure}{.33\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{images/Chapter1/Sprouse_GePpeTto_PenLP-zscores-likert.png} 
		\caption{1c}
		\label{fig:wh_adjunct3}
	\end{subfigure}
	\caption{plots of....}
	\label{fig:fig}
\end{figure}
