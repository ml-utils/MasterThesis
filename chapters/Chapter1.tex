...
Consider the following examples (\ref{no_filler_gap_1} and \ref{filler_gap_1} in English, \ref{no_filler_gap_1_it} and \ref{filler_gap_1_it} in Italian), in which we mark the gaps with underscores, and the fillers in bold:
...
\begin{exe}
	...
	\ex \gll \textbf{Cosa}	pensi	che io abbia comprato \textbf{\_}?\\
	What think 	that I have bought \\
	\glt `What do you think I bought?'\label{filler_gap_1_it}
\end{exe}
