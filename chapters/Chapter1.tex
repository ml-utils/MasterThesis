...
\begin{table} \scriptsize 
	\begin{center}
		\begin{tabular}{p{0.095\linewidth}|p{0.099\linewidth}|c|p{0.05\linewidth}|c|p{0.04\linewidth}|p{0.04\linewidth}|p{0.04\linewidth}|c|p{0.04\linewidth}|c|p{0.04\linewidth}|}
			...
			& DD & \textbf{100} & \textbf{100} & 4 \\ 
			\hline
			\textbf{Average} & & 81.5\% & \textbf{88.5\%} & 48\%    \\ 	
...
\begin{table} \scriptsize 
	\begin{center}
		\begin{tabular}{p{0.095\linewidth}|p{0.099\linewidth}|c|p{0.05\linewidth}|c|p{0.04\linewidth}|p{0.04\linewidth}|p{0.04\linewidth}|c|p{0.04\linewidth}|c|p{0.04\linewidth}|}
			...
			& Long-N.I. & \textbf{100} & \textbf{100} & \textbf{100} & \textbf{100} & \textbf{100} & 78  \\ 
			& Short-I.S. & 64 & \textbf{98} & 90 & 96  & 62 & 76  \\ 	
			
		  	\hline
			\multirow{3}{0.8cm}{Wh-adjunct}  
						& Short-N.I. & \textbf{96} & 92 & 94 & 90 & 94 & 92  \\ 
					   	& Long-N.I. & \textbf{98} & 86 & 68 & 42 & 90 & 58  \\ 
		  	 		    & Short-I.S. & 96 & 98 & \textbf{100} & 98 & \textbf{100} & \textbf{100}  \\ 
		  	\hline
		  	\multirow{3}{0.8cm}{Wh-complex np} 
		  				& Short-N.I. & 90 & 92 & \textbf{100} & \textbf{100} & 84 & 88  \\ 
		  			  	& Long-N.I. & \textbf{100} & 42 & 96 & 92 & 44 & 16  \\ 
		  				& Short-I.S. & 38 & 88 & \textbf{100} & \textbf{100} & 78 & 90  \\ 		  			 
		  	\hline
		  	\multirow{3}{0.8cm}{Wh-subject} 
		  				& Short-N.I. & \textbf{100} & 94 & 28 & 8 & 98 & 72  \\ 
					  	& Long-N.I. & \textbf{100} & 98 & 86 & 56 & 96 & 86  \\ 
		  				& Short-I.S. & 40 & 56 & 62 & 60 & 56 & 62  \\ 

		  	\hline
		  	\textbf{Average} & & 84.5\% & \textbf{86.7\%} & 85.3\% & 78.5\% & 83.5\% & 76.5\%    \\ 	
...
We can see that the plots for whether (top-left plot of each figure), adjunct (bottom-right), and subject islands (bottom-left) from the GPT-2 model (\autoref{fig:md_gpt_penlp}) are quite similar with those obtained on human subjects (\autoref{fig:sprouse_humans}), with the difference that for adjunct islands, the \textsc{short-island} sentence gets a higher acceptability score from the transformer model (this might be due to the confound deriving from the format of this sentence, as discussed in section ..).

There is also a difference regarding whether islands, in which, for GPT-2 (\autoref{fig:md_gpt_penlp}), the non-island sentences increase in acceptability when going from short-distance to long-distance dependencies, whereas for human subject it is the opposite, there is a decrease in acceptability. This discrepancy is present also in the plots for BERT (\autoref{fig:md_bert_lp}), while GilBERTo is the only model that shows the same trend as in humans for this line (\autoref{fig:md_gilberto_lp}). These trends are the same also in the plots for the results on the same Sprouse dataset that was used on humans (\autoref{fig:plots_3_sprouse}-\autoref{fig:plots_4_sprouse}).

To explain why, we looked at the surprisal for each token (the sentence score is just the sum of the token surprisals, negative). In the example sentence Fig. .., we see that this is due to a lexical and sentence length difference between the short-nonisland ("\textit{Chi pensa che io abbia studiato la teoria?}") and the long-nonisland ("\textit{Cosa pensi che io abbia studiato?}"). The short-nonisland sentence contains the phrase "\textit{la teoria}", that is not present in the long-nonisland sentence and causes two spikes in surprisals that make the short-nonisland PLL score (-18.73) worse than the long-nonisland sentence (-14.72). We'll do follow-up experiments balancing the lexical content of the sentences.
...
\begin{figure}
	...
	\ULsubfloat[Fig.\ref{fig:md_gilberto_lp} \label{fig:md_gilberto_lp}]{%
		\includegraphics[width=.9\textwidth]{images/Chapter1/Madeddu_wh_idb-ita_gilberto-uncased-from-camembert_LP-zscores-likert-2022-09-14_h15m47s06.png}%
	}
...
\begin{figure}
	...
	\ULsubfloat[Fig.\ref{fig:sprouse_gilbertot_lp}  \label{fig:sprouse_gilbertot_lp}]{%
		\includegraphics[width=.9\textwidth]{images/Chapter1/Sprouse_wh_idb-ita_gilberto-uncased-from-camembert_LP-zscores-likert-2022-09-14_h17m28s42.png}%
	}
	\vspace{10pt}
